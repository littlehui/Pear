...
import com.pear.commons.selector.mybatis.provider.CrudProvider;
...
public interface BaseDAO<T > {
     ...
     * @return 结果集
     */
    @SelectProvider(type = CrudProvider.class, method = "findBySqlQuery")
    List<Map<String, Object>> findBySqlQuery(SqlQuery sqlQuery);

    @SelectProvider(type = CrudProvider.class, method = "countBySqlQuery")
    int countBySqlQuery(SqlQuery query);
